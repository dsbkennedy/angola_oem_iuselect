...
commune_over71_map_fn <- function(x) {
...
angola_commune_oncho_loaloa_over71_map <- commune_over71_map_fn(angola_commune_oncho_loaloa_over71)
angola_commune_oncho_noloaloa_over71_map <- commune_over71_map_fn(angola_commune_oncho_noloaloa_over71)
...
noloaloa <- weighted_mean_map_fn("Non-endemic")
