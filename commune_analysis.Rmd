...
angola_commune_oncho_over71_map <- commune_over71_map_fn(angola_commune_oncho_loaloa_over71,'All endemicity categories')
angola_commune_oncho_unknown_over71_map <- commune_over71_map_fn(angola_commune_oncho_loaloa_over71 %>% filter(grepl('Unknown', Endemicity)), 'Unkown endemicity only')

angola_commune_oncho_over71_map + angola_commune_oncho_unknown_over71_map +  plot_layout(guides = "collect") & theme(legend.position = 'bottom')
